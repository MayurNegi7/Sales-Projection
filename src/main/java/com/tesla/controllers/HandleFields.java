...
public abstract class HandleFields {
    ...
    public TextField productTypeField; // Added TextField for Product Type
    ...
    public boolean isDatasetValid(MyMap<String, String[]> records1, MyMap<String, String[]> records2, TextField size) {
        ...
        // Check if productType is filled
        if (productTypeField== null || Objects.equals(productTypeField.getText(), "")) {
            AlertBox.displayAlert("Fill in the blanks", "Please enter product type!");
            return false;
        }
