...
public class Dataset {
    ...
    private final String productType; // Updated to String
    ...
    public String getProductType() {
        return productType; // New getter for product type
    }
    ...
    public MyArrayList<Integer> getListOfRecords() {
        MyArrayList<Integer> listOfRecords = new MyArrayList<>();
        for (MyArrayList<String> month : allRecords) {
    ...
    public void printProductType() {
        System.out.println("Product Type: " + productType); // Print statement added
    }
}
